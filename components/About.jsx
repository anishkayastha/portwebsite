            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-col xl:flex-row">
                    ...
                    <div className="hidden xl:flex flex-1 relative">
                        <DevImg 
                            conatinerStyles='bg-about_shape_light dark:bg-about_shape_dark w-[505px] h-[505px] bg-no-repeat relative' 
                            ...
                            <div className="text-lg mt-12 xl:mt-8">
                                ...
                                <TabsContent value='personal'>
                                    <div className="text-center xl:text-left">
                                        ...
                                        <p className="subtitle max-w-xl mx-auto xl:mx-0">I specialize in creating in crafting intuitive websites with cutting-edge technology, delivering dynamic and engaging user experiences.</p>
                                    </div>
                                </TabsContent>
